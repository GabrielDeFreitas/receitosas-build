          ...
          <div className="w-full justify-start items-start gap-8 grid md:grid-cols-3 grid-cols-1">
            <div className="w-full flex-col justify-start items-start gap-2.5 inline-flex">
              ...
              <p className="text-gray-400 text-base font-normal leading-relaxed">
                Gather all necessary data or materials required for the process.
                For example, in a 3D printing project, this involves preparing
                the digital design files and ensuring the printer has sufficient
                filament.
              </p>
            </div>
            <div className="w-full flex-col justify-start items-start gap-2.5 inline-flex">
              ...
              <p className="text-gray-400 text-base font-normal leading-relaxed">
                Execute the core mechanism or operation. For 3D printing, this
                step includes the printer interpreting the digital model and
                methodically laying down layers of material to build the object.
              </p>
            </div>
            <div className="w-full flex-col justify-start items-start gap-2.5 inline-flex">
              <div className="w-full flex justify-between relative">
              ...
              <p className="text-gray-400 text-base font-normal leading-relaxed">
                Finalize the process and assess the results. In 3D printing,
                this means removing the finished object from the printer,
                inspecting it for quality, and performing any necessary
                post-processing steps like sanding or painting.
              </p>
            </div>
          </div>
        </div>
